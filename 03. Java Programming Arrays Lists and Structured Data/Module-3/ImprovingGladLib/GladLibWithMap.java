...
public class GladLibWithMap {
    ...
    private void initializeFromSource(String source) {
        String [] labels = {"adjective", "noun", "color", "country","name",
            "animal", "timeframe", "fruit", "verb"};
        for(int i =0;i<labels.length;i++)
        {
            ArrayList <String> list = readIt(source+"/"+labels[i]+".txt");
            myMap.put(labels[i], list);
        } 
    }
    ...
    //Write a new method named totalWordsConsidered with no parameters. This method returns the total number of words in the ArrayLists of the categories that were used for a particular GladLib.
    ...
    public void makeStory(){
        ...
        printOut(story, 60);
        System.out.println("\n");
        System.out.println("Total words replaced: "+wordList.size());
